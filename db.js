// db.js
// This file connects to MongoDB and defines what a "record" looks like.

const mongoose = require('mongoose');

// Connect to your local MongoDB
mongoose.connect(process.env.MONGO_URL);
// "Schema" = the shape of one saved record
const entrySchema = new mongoose.Schema({
  total:    Number,
  t:        Number,   // transport kg
  e:        Number,   // electricity kg
  f:        Number,   // food kg
  food:     String,   // diet type e.g. "vegan"
  date:     String,   // formatted date string
  savedAt:  { type: Date, default: Date.now }
});

// "Model" = the tool we use to save/read records
